            ...
            <MotionDiv variants={fadeIn("up", "tween", 0.1, 0.5)}>
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="md:w-1/2 w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-pink-200 p-3  text-sm md:text-md  font-semibold rounded-b-lg rounded-s-lg">
                  ...
                  {/* JOB DATE */}
                  <div className="lg:py-3 p-1 text-pink-400 text-sm font-semibold">
                    2019 - 2024{" "}
                  </div>
                  {/* JOB COMPANY */}
                  <div className="lg:py-3 p-1 rounded bg-white text-sm font-semibold w-fit">
                    Microsoft
                  </div>
                </div>
                {/* CENTER */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/6 flex justify-center">
                  {/* LINE */}
                  <div className="w-1 h-full bg-emerald-500  rounded relative">
                    {/* LINE CIRCLE */}
                    <div className="absolute w-5 h-5 rounded-full ring-4 ring-green-300 bg-white -left-2"></div>
                  </div>
                </div>
                {/* RIGHT */}
                <div className="md:w-1/2 w-1/3  ">
